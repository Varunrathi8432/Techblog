		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link" href="profile.jsp">Home</a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="contact_page_login.jsp">Contact</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="thank-you-container">
			...
			<p>
				We will get back to you soon. Meanwhile, feel free to <a
					href="profile.jsp">return to the homepage</a> or <a
					href="contact_page_login.jsp">contact us again</a>.
			</p>
		</div>
	</div>
